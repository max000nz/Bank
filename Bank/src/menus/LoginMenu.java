...
public abstract class LoginMenu {
    ...
    public static RoleType ShowLoginMenu(){
        ...
        while(true){
            ...
            int id=0;
            try {
                id = RoleAns.idInput("Please enter your id: ", 100000000, 999999999);
            } catch (Exception ex) {
                System.out.println(ex.getMessage());
            }
            String password="";
            try {
                password = RoleAns.passwordInput("Please enter your password: ", 100000000, 999999999);
            } catch (Exception ex) {
                System.out.println(ex.getMessage());
            }
